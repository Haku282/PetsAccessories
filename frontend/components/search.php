...
<body>
    ...
    <main class="products-page" style="padding: 40px 0;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 15px;">
            <section class="search-results-section product-section">
                <h2 style="margin-bottom: 20px; border-bottom: 2px solid #ddd; padding-bottom: 10px;">
                    <?php echo empty($searchQuery) ? 'Tìm kiếm' : htmlspecialchars($pageTitle); ?>
                </h2>
                ...
                <?php elseif (empty($products)): ?>
                    <p style="text-align: center; color: #777; font-size: 16px; padding: 50px 0;">Không tìm thấy sản phẩm nào phù hợp với từ khóa của bạn.</p>
                <?php else: ?>
                    <p style="margin-bottom: 20px; font-size: 16px; color: #555;">Tìm thấy <strong><?php echo count($products); ?></strong> sản phẩm phù hợp.</p>
